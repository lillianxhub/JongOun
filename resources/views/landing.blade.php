...
<body class="bg-gray-100">
    <nav class="flex justify-between p-6 bg-white shadow">
        ...
        <div class="space-x-4">
            ...
            @auth
            <a href="{{ route('profile.bookings') }}" class="bg-black hover:bg-gray-800 text-white font-semibold px-4 py-2 rounded shadow transition">Profile</a>
            @else
            <a href="{{ route('login') }}" class="bg-black hover:bg-gray-800 text-white font-semibold px-4 py-2 rounded shadow transition">Sign In</a>
            @endauth
        </div>
    </nav>
    ...
    <section id="service" class="p-20 bg-white">
        ...
        <div class="flex flex-col gap-10">
            <!-- Room 1: Image Right -->
            <div class="flex flex-col md:flex-row items-center bg-gray-50 rounded-xl shadow p-6">
                <div class="flex-1 order-2 md:order-1 text-center md:text-left">
                    ...
                    <a href="{{ route('booking') }}" class="bg-black hover:bg-gray-800 text-white font-semibold px-4 py-2 rounded shadow transition">Book Now</a>
                </div>
                <div class="flex-1 order-1 md:order-2 flex justify-center mb-4 md:mb-0">
                    <img src="/images/rooms/room1.png" alt="Room A" class="w-100 h-45 object-cover rounded-lg shadow-md" />
                </div>
            </div>
            <!-- Room 2: Image Left -->
            <div class="flex flex-col md:flex-row items-center bg-gray-50 rounded-xl shadow p-6 gap-20">
                <div class="flex-1 flex justify-center mb-4 md:mb-0">
                    <img src="/images/rooms/room2.png" alt="Room B" class="w-100 h-45 object-cover rounded-lg shadow-md" />
                </div>
            ...
            <div class="flex flex-col md:flex-row items-center bg-gray-50 rounded-xl shadow p-6">
                ...
                <div class="flex-1 order-1 md:order-2 flex justify-center mb-4 md:mb-0">
                    <img src="/images/rooms/room3.png" alt="Room C" class="w-100 h-45 object-cover rounded-lg shadow-md" />
                </div>
            </div>
        </div>
    </section>
    ...
    <footer id="about" class="w-full bg-white py-12 px-4 mt-10">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-20">
            ...
            <div class="flex-1 mb-8 md:mb-0">
                ...
                <p>At JongOun, we believe that every great performance begins with the perfect rehearsal. Our platform makes it easy to discover, book, and manage music rehearsal rooms that fit your schedule and style. Whether you are a solo artist preparing for your next gig, a band polishing your sound, or simply someone who loves making music, JongOun is here to provide a convenient and inspiring space. We are committed to making the booking process simple, transparent, and accessible, so you can focus on what matters most — creating music.</p>
            </div>
            <div class="flex-1">
